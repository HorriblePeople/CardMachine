...
RulesDict={
    ...
    "{goal}": "You may discard 1 active Goal and draw 1 new one to replace it.",
    ...
    "{love poison}": "Instead of playing this ship with a Pony card from your hand, or connecting two ponies already on the grid, you may take a Pony card from the shipping grid and reattach it elsewhere with this Ship. That card's power activates.",
